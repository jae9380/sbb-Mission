...
import com.example.sbbmissoin.question.entity.QuestionForm;
...
public class QuestionController {
    ...
    public String detail(
            Model model, @PathVariable("id") Integer id, AnswerForm answerForm
            ){
    ...
    public String questionCreate(
        ...
        if (bindingResult.hasErrors()) return "question/form";
    ...
    public String questionVote(Principal principal, @PathVariable("id") Integer id) {
        Question question = this.questionService.getQuestion(id);
        UserEntity userEntity = this.userService.getUser(principal.getName());
        this.questionService.vote(question, userEntity);
        return String.format("redirect:/question/detail/%s", id);
    }
}
